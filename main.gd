...
const MODELS := ["res://models/fortuneteller.glb", "res://models/puzzle2.glb", "res://models/chariot.glb", "res://models/dragon.glb", "res://models/unicorn.glb", "res://models/fan.glb"]
